...
public final class Guards {
        ...
        for (final T value : values) {
            if (value == null)
                throw new IllegalArgumentException("Element at index " + i
                        + " was a null value, which is not permitted.");
            i++;
        }
    }
    ...
    public static boolean compareBigDecimal(
        ...
        while (leftIterator.hasNext() && rightIterator.hasNext()) {
            ...
            if (!(l == r || l != null && r != null && l.compareTo(r) == 0))
                return false;
        }
    ...
    private static final Comparator<BigDecimal> bigDecimalComparator = new Comparator<BigDecimal>() {
        ...
        public int compare(final BigDecimal left, final BigDecimal right) {
            return left == null && right == null ? 0 : left == null
                    ? -1
    ...
    public static boolean compareBigDecimal(
        ...
        final BigDecimal[] leftSorted = left
                .toArray(new BigDecimal[left.size()]);
        Arrays.sort(leftSorted, bigDecimalComparator);
        final BigDecimal[] rightSorted = right.toArray(new BigDecimal[right
                .size()]);
